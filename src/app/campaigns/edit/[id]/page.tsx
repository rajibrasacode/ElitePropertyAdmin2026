...
export default function EditCampaignPage() {
    ...
    const mutation = useMutation({
        ...
        onSuccess: (response: any) => {
            ...
            if (isSuccess || response?.id) { // fallback if response is just the object
                ...
                showErrorToast(response?.message || "Failed to update campaign");
            }
        },
        onError: (error: any) => {
    ...
    if (isFetching) {
        return <div className="p-10 text-center">Loading campaign details...</div>;
    }
    ...
    return (
        <div className="max-w-[1600px] mx-auto pb-20 fade-in-up">
            ...
            <PageHeader
                ...
                subtitle="Update campaign details and settings"
                actions={
                    <>
                        <button
                            type="button"
                        ...
                        >
                            <MdSave size={18} />
                            <span>{mutation.isPending ? "Updating..." : "Update Campaign"}</span>
                        </button>
                    </>
                }
            />
